...
@Slf4j
public class SlidingTimeWindowMain {

  public static void main(String[] args) {
    Properties config = getStreamProperties("sliding-window-app", "sliding-window-config");
  ...
  private static Topology initTopology() {
    ...
    KTable<Windowed<String>, Long> output = clickTopic
        ...
        .windowedBy(SlidingWindows.ofTimeDifferenceWithNoGrace(Duration.ofMillis(300)))
